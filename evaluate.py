...
from utils.array import to_tensor, recursive_slice, recursive_deepcopy
...
from agents.sac import Agent as SACAgent
from agents.bc import Agent as BCAgent
from envs.planner import PickSubtask, PlaceSubtask, OpenSubtask, CloseSubtask
...
def eval(cfg: EvalConfig):
                    ...
                    for subtask_num in currently_running_nav_subtasks:
                        ...
                        for _ in range(MAX_SPAWN_ATTEMPTS):
                            ...
                            nav_success = (
                                ...
                                # & (
                                #     dist_from_goal
                                #     <= uenv.navigate_cfg.navigated_sucessfully_dist
                                # )
    ...
    def update_pbar(step_num):
        ...
        # pbar.set_description(f"step={step_num}, ptr={uenv.subtask_pointer.tolist()}")
